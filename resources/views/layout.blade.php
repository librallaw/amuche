            ...
            <div class="navigationbar">
                <ul class="vertical-menu">
                    ...
                    @if(Auth::user()->level == 2)
                        <br />
                        <li class=""  style="padding-left: 30px;">
                            <h6 class="ps-4  ms-2 text-uppercasde text-xs font-weight-bolder text-">Finance</h6>
                        </li>
                    ...
                    <li class="nav-item ">
                        <a class="" href="/logout">
                            ...
                            <span class="-text ms-2 ps-1"> Logout </span>
                        </a>
                    </li>
                                            ...
                                            <div class="userbox">
                                                <ul class="list-unstyled mb-0">
                                                    <li class="media dropdown-item">
                                                        <a href="/account/reset" class="profile-icon"><img src="/assets/images/svg-icon/user.svg" class="img-fluid" alt="user">Settings</a>
                                                    </li>
